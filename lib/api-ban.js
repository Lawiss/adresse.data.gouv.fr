...
export function getFantoir(codeDepartement) {
  return _fetch(`${API_BAN_URL}/api-fantoir/departements/${codeDepartement}/communes`)
}

export function getVoiesFantoir(codeCommune) {
  return _fetch(`${API_BAN_URL}/api-fantoir/communes/${codeCommune}/voies`)
}

export function getVoieFantoir(codeVoie) {
  return _fetch(`${API_BAN_URL}/api-fantoir/voies/${codeVoie}`)
}

export function getCommune(codeCommune, signal) {
  return _fetch(`${API_BAN_URL}/lookup/${codeCommune}`, {signal})
}
